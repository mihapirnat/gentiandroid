...
public class OpenMasterPasswordDialog {
	public static abstract class CallBack {
		public abstract boolean passwordSet(String password);
	}
	final Dialog viewDialog;
	public OpenMasterPasswordDialog (final GentianChat main, final CallBack callback) {
		...
		okButton.setOnClickListener(new OnClickListener() {
			...
			if (callback.passwordSet(pass.getText().toString())) {

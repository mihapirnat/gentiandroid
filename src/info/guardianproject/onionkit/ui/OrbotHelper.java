...
public class OrbotHelper {
	...
	public void promptToInstall(Activity activity) {
		...
		showDownloadDialog(activity,
				activity.getString(R.string.install_orbot_),
				activity.getString(R.string.you_must_have_orbot),
				activity.getString(R.string.yes),
				activity.getString(R.string.no), uriMarket);
	}
	...
	public AlertDialog requestOrbotStart(final Activity activity,
			final Runnable onSomeChoice) {
		return requestOrbotStart(activity, onSomeChoice, null);
	}

	public AlertDialog requestOrbotStart(final Activity activity,
			final Runnable onSomeChoice, final String title) {
		...
		downloadDialog.setPositiveButton(R.string.yes,
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialogInterface, int i) {
